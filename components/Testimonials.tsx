...
const testimonials: Testimonial[] = [
  {
    text: "Desde o primeiro contato fui muito bem atendida. A equipe entendeu exatamente o que eu precisava e entregou o site dentro do prazo combinado. O investimento realmente valeu a pena.",
    name: "Patrícia",
    sector: "Loja de Varejo",
    initials: "PA",
  },
  {
    text: "Eu tinha apenas uma ideia vaga do que queria. Eles me ajudaram a transformar isso em um projeto organizado, bonito e funcional. O resultado superou minhas expectativas.",
    name: "Rafael",
    sector: "Empresa de Serviços",
    initials: "RA",
  },
  {
    text: "O aplicativo ficou muito fácil de usar, até para quem não tem experiência com tecnologia. Meus clientes elogiaram bastante a praticidade.",
    name: "Juliana",
    sector: "Agendamentos",
    initials: "JU",
  },
  {
    text: "Além de entregarem tudo no prazo, o suporte depois da entrega fez toda a diferença. Sempre que precisei, fui atendido rapidamente.",
    name: "Carlos",
    sector: "Site Institucional",
    initials: "CA",
  },
  {
    text: "Nosso site passou muito mais credibilidade para os clientes. Em pouco tempo já percebemos um aumento nas solicitações de orçamento.",
    name: "Fernanda",
    sector: "Arquitetura",
    initials: "FE",
  },
  {
    text: "A comunicação foi excelente durante todo o projeto. Sempre recebi atualizações e minhas dúvidas eram respondidas com rapidez.",
    name: "Marcelo",
    sector: "Consultoria",
    initials: "MA",
  },
  {
    text: "Gostei muito da transparência em todas as etapas. Não tentaram vender algo desnecessário e entregaram exatamente o que foi combinado.",
    name: "Renata",
    sector: "Clínica de Estética",
    initials: "RE",
  },
  {
    text: "Foi um investimento que trouxe retorno. O novo site deixou nossa empresa mais profissional e facilitou muito o contato com novos clientes.",
    name: "Eduardo",
    sector: "Manutenção Residencial",
    initials: "ED",
  },
];
